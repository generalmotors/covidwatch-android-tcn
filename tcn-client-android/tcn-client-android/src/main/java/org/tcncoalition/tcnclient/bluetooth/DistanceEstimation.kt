...
const val measuredRSSIAtOneMeterDefault: Int = -57
const val convertToFeetFactor : Double = 3.28084
...
fun getEstimatedDistanceFeet(
    ...
    return ((10.0.pow((measuredRSSIAtOneMeter - RSSI) / (10.0 * environmentalFactor))) * convertToFeetFactor)
}